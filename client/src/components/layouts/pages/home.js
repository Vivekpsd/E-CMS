...
function Home() {
  ...
  const [ cardState ] = useState({
    cards: [
      { id: '1', title: '2021 Complete Python Bootcamp 2021 Complete Python Bootcamp 2021 Complete Python Bootcamp', instructor: 'joe Biden', price: '$200'},
      { id: '2', title: '2021 Complete Python Bootcamp', instructor: 'joe Biden', price: '$200'},
      { id: '3', title: '2021 Complete Python Bootcamp', instructor: 'joe Biden', price: '$200'},
      { id: '4', title: '2021 Complete Python Bootcamp', instructor: 'joe Biden', price: '$200'}
    ]
  });
  ...
  return (
    <div className="App">
      <Container>
        <Topsection headimage = {Svg} head = "E-GURUKUL" description = {<p>A new way to get educate <br /> and learn from anywhere.</p>}/>
        <Titles/>
      </Container>
      <hr/>
      <Container>
        <div className = "heading-bts">
          ...
          <p>Choose from various courses taught by the professional teachers.</p>
        </div>
        { cards }
        <FeaturedCource 
